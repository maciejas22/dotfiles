...
```bash
npx ts-node /Users/maciejas22/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/Users/maciejas22/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
