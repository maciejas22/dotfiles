...
**Rule**: If it's not in `/Users/maciejas22/.config/opencode/context/`, use ExternalScout.
...
| **Location** | `/Users/maciejas22/.config/opencode/context/` | Internet (Context7, docs) |
