...
- **Task Delegation**: `/Users/maciejas22/.config/opencode/context/core/workflows/task-delegation-basics.md` — How to reference external context in sessions
- **Session Management**: `/Users/maciejas22/.config/opencode/context/core/workflows/session-management.md` — Session lifecycle
