...
/Users/maciejas22/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /Users/maciejas22/.config/opencode/context/{category}
...
```bash
cat > /Users/maciejas22/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/Users/maciejas22/.config/opencode/context/{category}/
...
Loads: `/Users/maciejas22/.config/opencode/context/ui/web/react-patterns.md`
