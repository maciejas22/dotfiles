...
**Context** (`/Users/maciejas22/.config/opencode/context/category/your-context.md`):
```yaml
---
...
```json
{
  ...
  "type": "context",
  "path": "/Users/maciejas22/.config/opencode/context/core/workflows/session-management.md",
  "aliases": [
    "workflows-sessions",
    "sessions"
  ],
